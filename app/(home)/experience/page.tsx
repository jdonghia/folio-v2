    ...
    <RouteContainer>
      ...
      <div className="ml-auto mt-20 flex w-5/6 flex-col items-end">
        ...
        <div className="mt-5 w-11/12 self-start text-xl">
          ...
          migrating the stack to React.js with TypeScript, Node.js with Express,
          ...
          ServiceNow. <br className="mb-3 mt-1" />
          &nbsp;&nbsp;&nbsp;&nbsp;• <b>Designed</b> and presented a proposal to
          restructure the MVP using Next.js, Prisma, and shadcn/ui, focusing on
          improvements in performance, scalability, and user experience.
          ...
          <br className="mb-3 mt-1" /> &nbsp;&nbsp;&nbsp;&nbsp;•{" "}
          <b>Presented</b> improvements in versioning practices (Git Flow and
          Conventional Commits) and coding standards (Clean Code and SOLID
          ...
          solutions with React.js integrated into ServiceNow, focusing on
          meeting business needs and improving user experience.
          <br className="mb-3 mt-1" /> &nbsp;&nbsp;&nbsp;&nbsp;•{" "}
          <b>Presented</b> boilerplate-based solutions with React.js to the
          development team on ServiceNow, enabling the use of SPAs and npm
          packages, overcoming platform limitations, and expanding development
          possibilities.
          <br className="mb-3 mt-1" /> &nbsp;&nbsp;&nbsp;&nbsp;•{" "}
          <b>Developed</b> a frontend application for external clients,
          featuring a modern interface and integration with the ServiceNow API,
          aimed at reducing user license costs on the platform.
          <br className="mb-3 mt-1" />
          &nbsp;&nbsp;&nbsp;&nbsp;• <b>Worked</b> as a JavaScript developer to
          create new features on the ServiceNow platform, contributing to
          enhanced efficiency in asset and investment management.
        </div>
      </div>
      <div className="my-20 ml-auto flex w-5/6 flex-col items-end">
        ...
        <div className="mt-5 w-11/12 self-start text-xl">
          &nbsp;&nbsp;&nbsp;&nbsp;• <b>Served</b> as the lead frontend developer
          on the team responsible for the creation and maintenance of the Spazio
          project: a web application for antenna management developed for TIM
          Brasil. <br className="mb-3 mt-1" />
          &nbsp;&nbsp;&nbsp;&nbsp;• <b>Contributed</b> to the migration of a
          Ruby monolithic application to a modern architecture using Vue.js with
